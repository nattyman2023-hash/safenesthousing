...
export const metadata: Metadata = { title: 'Contact Safe Nest', description: 'Talk to Safe Nest Housing & Support.' };

export default function ContactPage() {
  return <main>
    <PublicPageHero eyebrow="Contact" title="Talk to us" intro="We are happy to answer questions about our services, properties, referrals, and partnerships." image={getServiceVisual('support')} imagePosition="72% 35%" />
