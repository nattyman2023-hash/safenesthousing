...
export default async function NewsPage() {
  ...
  return <main>
    <PublicPageHero eyebrow="News & stories" title="From the Nest" intro="Updates, ideas, and honest reflections from our homes and the people connected to them." image={getPropertyVisual()} />
