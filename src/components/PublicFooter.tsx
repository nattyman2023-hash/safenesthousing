...
export function PublicFooter() {
  return <footer className="site-footer">
    <div className="container footer-grid">
      <div><Link href="/" className="wordmark wordmark-footer"><span>Safe Nest</span><small>Housing &amp; Support</small></Link><p className="footer-copy">A safe place to land. The support to move on.</p></div>
      ...
      <div><p className="footer-label">Talk to us</p><div className="footer-links"><a href="mailto:hello@safenest.example">hello@safenest.example</a><a href="tel:01234000000">01234 000 000</a><Link href="/contact">Contact us</Link><Link href="/referrals">Make a referral</Link></div></div>
